  ...
  background: #3498db; padding: 15px 30px 15px 30px;";>成立于1999年</span></p>
							...
							<div class="flex_cell no_margin av_one_half  avia-builder-el-36  el_after_av_cell_one_half  avia-builder-el-last no-padding">
								<div class="flex_cell_inner qr-code">
									<p><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/cg16_home_footer1.png" /></p>
								</div>
							</div>
						</div>
					</div>
